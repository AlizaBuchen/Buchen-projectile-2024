...
public class ProjectileGraph extends JComponent
{
    ...
    Projectile projectileCopy = projectile;
    ...
    protected void paintComponent(Graphics g)
    {
        ...
        String locationSeconds = "(" + FORMAT.format(projectile.getX()) + ", " +
                FORMAT.format(projectile.getY()) + ")";
        g.setColor(Color.RED);

        projectile.setSeconds(0);

        g.drawString(locationSeconds, (int) (projectileCopy.getX()), (int) -projectileCopy.getY());
